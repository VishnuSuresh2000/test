      ...
      content: Container(
        ...
        child: Column(
          children: [
            ...
            Text("Avaialble : ${temp.count} ${widget.product.inKg?'kg':'piece'}"),
            Padding(
                    ...
                    children: [
                      if (!showTextFiled)
                        InkWell(
                          ...
                          child: Center(
                            child: Text("$value ${widget.product.inKg?'kg':'piece'}"),
                          ),
                        ),
                      if (showTextFiled)
                        Form(
                            ...
                            validator: (value) {
                              if (value.isNotEmpty) {
                                try {
                                  ...
                                  if (temp2 > temp.count) {
                                    errorAlert(
                                        context, "Must be less than Avaialble");
                                    return null;
                                  }
                                  return null;
                                } catch (e) {
                ...
                DropdownButton(
                    ...
                    items: widget.product.salles
                        .map((e) => DropdownMenuItem<Salles>(
                            value: e, child: Text("${e.farmer.fullName}")))
                        .toList(),
                    onChanged: (value) {
                      temp = value;
                      setState(() {});
